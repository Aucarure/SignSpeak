...
import { Plus, Edit, Trash2, Eye, UserCheck, UserX, Shield } from 'lucide-react'
...
export default function UsuariosPage() {
  ...
  const handleEdit = (usuario) => {
    ...
    setFormData({
      ...
      is_staff: usuario.is_staff || false  // ← NUEVO
    })
    setFormErrors({})
    setIsModalOpen(true)
  }
  ...
  const stats = {
    ...
    administradores: usuarios.filter(u => u.is_staff).length,  // ← NUEVO
      ...
      <div className="max-w-7xl mx-auto space-y-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-5 gap-4">
          ...
          <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-4">
            ...
            <p className="text-2xl font-bold text-purple-600">{stats.administradores}</p>
          </div>
          <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-4">
                ...
                <tbody className="divide-y divide-gray-200">
                  {filteredUsuarios.map((usuario) => (
                    <tr key={usuario.id_usuario} className="hover:bg-gray-50 cursor-pointer" onClick={() => handleView(usuario)}>
                      ...
                      <td className="px-6 py-4">
                        {usuario.is_staff ? (
                          <span className="flex items-center gap-1 px-2 py-1 text-xs font-semibold rounded-full bg-purple-100 text-purple-800 w-fit">
            ...
            <div className="bg-white rounded-lg max-w-md w-full p-6 max-h-[90vh] overflow-y-auto">
              ...
              {modalMode === 'view' && selectedUsuario ? (
                <div className="space-y-4">
                  ...
                  <div>
                    ...
                    <p className="text-base text-gray-900">
                      {selectedUsuario.is_staff ? '👑 Administrador' : 'Usuario'}
                    </p>
                  </div>
                  <div>
                ...
                <div className="space-y-4">
                  ...
                  {/* NUEVO: Checkbox para administrador */}
                  <div className="flex items-center space-x-2 p-3 bg-purple-50 rounded-lg border border-purple-200">
                    ...
                    />
                    <label htmlFor="is_staff" className="text-sm font-medium text-purple-900 flex items-center gap-2">
