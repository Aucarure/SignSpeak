...
export default function Sidebar() {
  ...
  const handleLogout = () => {
    // Limpiar el token/sesión y cualquier otro dato guardado
    ...
    // Opción 1: Ruta absoluta (desarrollo)
    // window.location.href = 'http://localhost:3000/login'
    
    // Opción 2: Ruta relativa (funciona en cualquier entorno)
    window.location.href = '/login'
    
    // Si prefieres usar navigate (pero recarga la página completa):
