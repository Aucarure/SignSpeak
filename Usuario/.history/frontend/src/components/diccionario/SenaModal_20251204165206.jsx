...
const SenaModal = ({ sena, isOpen, onClose }) => {
  ...
  // Reset estado cuando se cierra o cambia la seña
  React.useEffect(() => {
    if (isOpen) {
      setIsPlaying(false);
          ...
          {videoId ? (
                  ...
                  {!thumbnailError ? (
                    <>
                      <img 
                        ...
                        onError={(e) => {
                          // Fallback a thumbnail de calidad media
                      ...
                      <div style={styles.thumbnailOverlay}>
                        <span style={styles.playText}>▶️ Reproducir Seña</span>
                      </div>
                    </>
                  ) : (
                    ...
                    <div style={styles.thumbnailFallback}>
                      ...
                      <button 
                        style={styles.playButtonFallback}
                        onClick={handlePlaySign}
                      >
                        ▶️ Reproducir Video
                      </button>
                      <p style={styles.fallbackText}>Video de YouTube disponible</p>
                    </div>
                  )}
                </div>
              ) : (
            ...
            <div style={styles.noVideoContainer}>
              ...
              <p style={styles.noVideoSubtext}>
                {sena.urlVideo 
                  ? `URL no válida: ${sena.urlVideo.substring(0, 50)}...`
