    ...
    <div style={styles.container}>
      ...
      <div style={styles.content}>
        ...
        <div style={styles.section}>
          ...
          <div style={styles.settingsGroup}>
            {/* Idioma */}
            <div style={styles.settingItemButton} onClick={() => alert('Próximamente: Gestionar perfil')}>
              <div style={styles.settingLeft}>
                <span style={styles.settingIcon}>👤</span>
                <div>
            ...
            <div style={styles.settingItemButton} onClick={() => alert('Próximamente: Tutoriales')}>
              <div style={styles.settingLeft}>
                <span style={styles.settingIcon}>❓</span>
                <div>
                  <div style={styles.settingLabel}>Ayuda y Tutoriales</div>
                  <div style={styles.settingDescription}>Aprende a usar la app</div>
                </div>
              </div>
              <span style={styles.chevron}>›</span>
            </div>
