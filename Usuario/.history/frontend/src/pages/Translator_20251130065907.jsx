...
const guardarConversacion = async () => {
  ...
  console.log('📝 Intentando guardar conversación:', {
    ...
    conversacion_completa: conversacionActual
  });
  ...
  try {
    ...
    console.log('📤 Enviando al backend:', {
      idConversacion: conversacionActual.idConversacion,
      guardada: nuevoEstado
    });
    ...
    console.log('✅ Respuesta del backend:', conversacionGuardada);
