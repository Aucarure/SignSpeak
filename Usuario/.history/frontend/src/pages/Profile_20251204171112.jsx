...
const Profile = () => {
  ...
  const [activeTab, setActiveTab] = useState('info'); // info, security, stats, danger
  ...
  useEffect(() => {
    const loadUserData = () => {
      ...
      if (savedUser) {
        ...
        // Datos de ejemplo si no hay guardados
        const defaultUser = {
          nombre: 'Juan',
          apellido: 'Pérez',
  ...
  const handleChangePassword = () => {
    ...
    // Aquí iría la lógica de cambio de contraseña con el backend
