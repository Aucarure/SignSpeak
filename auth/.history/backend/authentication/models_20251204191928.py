...
class UsuarioManager(BaseUserManager):
    ...
    def create_superuser(self, email, nombre, password=None, **extra_fields):
        ...
        extra_fields.setdefault('tipo_usuario', 'oyente')
        ...
        return self.create_user(email, nombre, 'oyente', password, **extra_fields)
...
class Usuario(AbstractBaseUser, PermissionsMixin):
    ...
    contraseña = models.CharField(max_length=255)  # Django lo gestiona como 'password'
    ...
    def save(self, *args, **kwargs):
        # Sincronizar el campo 'contraseña' con el password de Django
