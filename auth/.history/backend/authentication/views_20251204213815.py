...
class LoginView(APIView):
    ...
    def post(self, request):
        ...
        # CAMBIO: Determinar redirección según is_staff
        if user.is_staff:
            redirect_to = '/administrador/dashboard'
        else:
            redirect_to = 'http://localhost:5173/traducir'  # CAMBIO: URL completa del frontend de usuario
