...
class UsuarioManager(BaseUserManager):
    ...
    def create_superuser(self, email, nombre, password=None, **extra_fields):
        ...
        # Extraer tipo_usuario antes de pasarlo
        tipo_usuario = extra_fields.pop('tipo_usuario', 'oyente')
        ...
        return self.create_user(email, nombre, tipo_usuario, password, **extra_fields)
